...
#cell_idx=np.where(cell_specimen_ids==517513783)[0][0]

# In[]
#sorted(cell_specimen_ids)
# In[]
...
#my_cell_mean_sweeps=[]
#for id in cell_idx:
#    my_cell_mean_sweeps.append(mean_sweep_response[id])
...
#this adds the cell_specimen_id to the peak dataframe
#peak['cell_specimen_id'] = pd.Series(csids, index=peak.index)